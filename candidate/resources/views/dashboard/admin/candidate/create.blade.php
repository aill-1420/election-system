                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="card-title">
                                    <h3 class="text-center title-2">new candidate</h3>
                                </div>
                                <hr>
                                <form action="{{route('candidate.store')}}" method="post" novalidate="novalidate" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="form-group">
                                                <label for="name" class="control-label mb-1">name</label>
                                                <input id="name" name="name" value="{{old('name')}}" type="text" placeholder="please enter name" class="form-control"
                                                       required>
                                                @error('name')
                                        ...
                                        <div class="col-6">
                                            ...
                                            <div class="input-group">
                                                <input id="username" name="username" value="{{old('username')}}" type="text" placeholder="please enter username" class="form-control"
                                                       required >
                                                @error('username')
                                                <span class="help-block" data-valmsg-for="cc-exp" data-valmsg-replace="true">{{$message}}</span>
                                                @enderror
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <input id="email" name="email" type="email" class="form-control" value="{{old('email')}}" placeholder="please enter email"
                                                       required>
                                                @error('email')
                                                <span class="help-block" data-valmsg-for="cc-exp" data-valmsg-replace="true">{{$message}}</span>
                                                @enderror
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <input id="phone" name="phone" type="tel" class="form-control" value="{{old('phone')}}" placeholder="please enter phone"
                                                       required>
                                                @error('phone')
                                                <span class="help-block" data-valmsg-for="cc-exp" data-valmsg-replace="true">{{$message}}</span>
                                                @enderror
